...
//Написать тесты для простых компонентов
//Написать тесты для компонентов с пропсами
//Написать тесты для компонентов с состоянием
//Написать тесты для хуков
//Написать тесты для асинхронных оепраций
